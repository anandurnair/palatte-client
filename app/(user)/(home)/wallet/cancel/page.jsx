  ...
  return (
    <div className=" purple-dark h-full bg-background text-foreground  flex flex-col justify-center overflow-scroll">
      <div className="w-full h-auto  flex flex-col items-center rounded-lg my-5">
        <div className="md:w-2/5 h-auto bg-semi  flex flex-col items-center  rounded-lg  z-10 shadow-2xl py-20 gap-y-5">
          <h2 className="md:text-2xl text-medium">Payment cancelled</h2>
          <Button
            variant="bordered"
            onClick={() => {
              router.push("/wallet");
