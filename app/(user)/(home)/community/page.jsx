  ...
  return (
    <>
      <div className='purple-dark h-full bg-background text-foreground flex gap-x-4 overflow-y-scroll'>
        <div className='h-full bg-semi w-2/6 shadow-lg rounded-lg p-4 overflow-y-auto'>
          ...
          {groupConversations.map((group) => (
            <div key={group._id} onClick={() => handleClickChat(group)}>
                ...
                <CardHeader className='justify-between'>
                  <div className='flex gap-5'>
                    <Avatar
                      ...
                      radius='full'
                      size='md'
                      src='https://www.shutterstock.com/image-vector/icon-people-gray-color-on-260nw-1032346549.jpg'
                    />
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        {/* AddGroupChatModal component goes here */}
      </Modal>
    </>
  );
};
